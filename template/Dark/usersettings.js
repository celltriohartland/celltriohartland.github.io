...
(function () {
	...
	model.publish(rh.consts('DATA_TOC_IMG_DATA_SET'),["template/Dark/tocimg1.png","template/Dark/tocimg2.png","template/Dark/tocimg3.png","template/Dark/tocimg4.png","template/Dark/tocimg5.png","template/Dark/tocimg6.png","template/Dark/tocimg7.png","template/Dark/tocimg8.png"]);
	model.publish(rh.consts('SHOW_SKIN_BCRUMBS'),true);
	model.publish(rh.consts('KEY_SHOW_ACCORDIAN'), true);
	model.publish(rh.consts('KEY_TOOLBAR_SEARCH'), true);
